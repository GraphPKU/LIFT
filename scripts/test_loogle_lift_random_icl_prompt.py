...
class LooGLEDataset(ICLContextDataset):
    def __init__(
        ...
        Args:
            context (`str`):
                The context (e.g. an article); the `input` attribute in LooGLE.
            title (`str`):
                The title; the `title` attribute in LooGLE.
            tokenizer (`transformers.PreTrainedTokenizer`):
                The tokenizer of the model to train.
            model_max_length (`int`, *optional*):
                The size of the context window of the model to train. The texts will be clipped to fit in the context
            ...
            title_option (`int`, *deprecated*):
                DEPRECATED! Fixed to 1.
            generator_name_or_path (`str`, *optional*).
                ...
                to None.
            use_cot (`bool`, *deprecated*):
                DEPRECATED! Fixed to False.
...
def prediction(
    ...
    for i, sample in enumerate(tqdm.tqdm(data, desc="Sample")):
        ...
        model = LooGLEtrain(context, title, tokenizer,
